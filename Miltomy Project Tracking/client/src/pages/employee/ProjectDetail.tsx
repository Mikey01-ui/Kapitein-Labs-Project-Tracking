      ...
      <div className="-mt-3 mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded bg-[#161616] border border-[#262626] hover:border-[#c8ff00] text-white hover:text-[#c8ff00] font-bold text-xs transition cursor-pointer"
          >
            <FileText size={15} className="text-[#c8ff00]" />
            <span>Project Agreement</span>
          </button>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-[#111111] border border-[#222222] rounded p-6 shadow-xl">
            ...
            <div className="mt-6 flex items-center justify-between rounded bg-[#161616] border border-[#262626] p-4 flex-wrap gap-3">
              <div className="flex items-center gap-3">
                <div className="p-2.5 rounded bg-[#c8ff00]/10 border border-[#c8ff00]/30 text-[#c8ff00]">
                  <FileText size={18} />
                </div>
                <div>
                  <span className="text-[10px] font-black uppercase tracking-widest text-[#c8ff00] block font-display">
                    Legal Engagement Agreement
                  </span>
                  <span className="text-xs font-bold text-white block">
                    Freelance Front-End Development Agreement &bull; $500.00 USD
                  </span>
                </div>
              </div>
              <button
                type="button"
                onClick={() => setIsContractModalOpen(true)}
                className="text-xs font-black text-[#080808] bg-[#c8ff00] hover:bg-[#b2e600] px-4 py-2 rounded transition flex items-center gap-1.5 shadow-md shadow-[#c8ff00]/15 cursor-pointer uppercase tracking-wider"
              >
