...
import {
  ...
  assignMember,
  removeMember,
  getProjectTrlHistory,
  updateProjectTrlLevel
...
projectsRouter.delete("/:id/force", requireRole("ADMIN"), deleteProject);
...
projectsRouter.get("/:id/trl", getProjectTrlHistory);
projectsRouter.post("/:id/trl", updateProjectTrlLevel);
